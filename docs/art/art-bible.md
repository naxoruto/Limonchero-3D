...
- **Ropa**: traje de contadora de los 50 — blusa blanca, chaqueta estructurada dorado-ocre `#C8A020`, falda a la rodilla. La chaqueta es el único elemento de color en su atuendo — deliberadamente ambigua bajo iluminación de neón (se lee como "amarillenta" a distancia, creando confusión con la piel de Barry). El color es visiblemente distinto del amarillo plátano `#F5D020` de Barry en luz directa, pero suficientemente cercano en penumbra para engañar al jugador
