...
#### Escenario — Props Faltantes
- [ ] **Agave** — planta decorativa del club (vestíbulo y/o barra), static mesh sin rigging
  - Low-poly facetado, agave azul estilizado, tono gris-verde `#5A7A4E`
  - ~200-400 tris, exportar como `agave_v1.glb`
