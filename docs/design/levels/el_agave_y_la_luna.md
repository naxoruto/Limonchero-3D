...
**NPCs:** Commissioner Wallace Papolicia (papa) — centro, da el briefing tutorial, entrega el Informe Preliminar del NFPD, recibe la acusación final.
...
**Frase de apertura:** Barry pronuncia su línea al inicio del juego, **siempre antes del briefing de Papolicia** — debe ser visible y audible antes de que el jugador tenga cualquier frame investigativo. El orden es invariable: Barry habla → Papolicia hace el briefing.
...
| Evidencia insuficiente + Barry nombrado | Papolicia acepta → final malo B1 (Barry queda libre, caso cerrado) |
| F4 o F5 GOOD + sospechoso incorrecto nombrado | Papolicia acepta sin escrutinio → finales malos B3/B4 |
...
|---|---|---|
| Papolicia | 0 — siempre habla | Ninguna |
...
| Acusación con notebook vacío | Papolicia da feedback ("eso es escaso, detective"); no hay crash |
...
- [ ] **CS-04** — Entrega de libreta a Papolicia inicia flujo de acusación
