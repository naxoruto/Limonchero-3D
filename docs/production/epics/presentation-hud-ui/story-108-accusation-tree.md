...
**ADR Decision Summary**: Árbol de diálogo scripteado con Spud. Checkboxes para evidencias (máx 3), campo texto para nombre acusado. Confession gate: F1+F2+F3 GOOD + accused="barry".
...
- [ ] Diálogo scripteado con Spud (no LLM). Misma línea de apertura siempre.
- [ ] Paso 1: Spud pregunta "Who did it, and what's your evidence?"
...
- [ ] Si incorrecto → Spud feedback "That's not right" + vuelve a paso 1
...
- [ ] Si jugador se aleja de Spud → diálogo se cancela

## Dependencies

- GameManager Story 003 (can_confess API)
- GameManager Story 004 (telemetría + accusation_attempts)
- InteractionSystem Story 001 (detectar Spud como interactuable)
